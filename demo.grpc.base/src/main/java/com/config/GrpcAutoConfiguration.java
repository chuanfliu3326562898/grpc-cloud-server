...
import com.annotation.GrpcServiceScan;
import com.client.DemoClient;
import com.proxy.GrpcServiceProxy;
import com.server.DemoServer;
import com.server.dto.ServerDto;
import com.utils.ClassNameUtils;
...
@Slf4j
@Configuration
@EnableConfigurationProperties(ServerDto.class)
public class GrpcAutoConfiguration {
    ...
    private final ServerDto grpcProperties;

    public GrpcAutoConfiguration(AbstractApplicationContext applicationContext, ServerDto grpcProperties) {
    ...
    public DemoClient grpcClient() {
        DemoClient client = new DemoClient(grpcProperties);
        client.init();
        return client;
    }
     ...
     */
    @Bean
    @ConditionalOnBean(DemoClient.class)
